        ...
        <div className="nav_Nav2">
          <div className="isOpen_Nav2">
            ...
            <div className="ml-auto_Nav2">
              <a
                onClick={this.handleViewDesktop}
              ...
              <a
                onClick={this.handleViewApple}
                className="nav-item_Nav2 nav-item2_Nav2"
              >
                <img src={apple} alt="Desktop logo" />
                <span>Apple</span>
              </a>
              <a onClick={this.handleViewASUS} className="nav-item_Nav2">
                <img src={asus} alt="Desktop logo" />
                <span>ASUS</span>
              </a>
              <a
                onClick={this.handleViewAll}
                className="nav-item_Nav2 nav-item4_Nav2"
              >
                Tất Cả
              </a>
            </div>
            <div className="cart-div_Nav2">
              <a href="">
                ...
                {data && data.length > 0 && data[0].TenLienHe}
              </a>
            </div>
          </div>
        </div>
