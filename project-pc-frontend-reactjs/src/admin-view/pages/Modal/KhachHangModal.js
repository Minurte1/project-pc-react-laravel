  ...
  const onSubmit = async (e) => {
    ...
    try {
      if (khachhang) {
        ...
        enqueueSnackbar("Thêm khách hàng mới thành công!", {
          variant: "success",
        });
      }
      handleSubmit();
      ...
      enqueueSnackbar(
        `Đã xảy ra lỗi. Vui lòng thử lại. Cụ thể là: ${
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>
          {khachhang ? "Sửa khách hàng" : "Thêm khách hàng mới"}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
              ...
              <Form.Group controlId="MA_PHAN_QUYEN">
                ...
                >
                  ...
                  {listPhanQuyen.map((phanQuyen) => (
                    <option
                      key={phanQuyen.MA_PHAN_QUYEN}
                      value={phanQuyen.MA_PHAN_QUYEN}
                    >
